...
public class DoubanMomentStory {
    ...
    private ArrayList<DoubanMomentPosts.thumbs> thumbs;
    ...
    private ArrayList<DoubanMomentPosts.thumbs> photos;
  ...
  public String getAbs() {
    ...
    public ArrayList<DoubanMomentPosts.thumbs> getThumbs() {
        return thumbs;
    }

    public void setThumbs(ArrayList<DoubanMomentPosts.thumbs> thumbs) {
        this.thumbs = thumbs;
    }
    ...
    public ArrayList<DoubanMomentPosts.thumbs> getPhotos() {
        return photos;
    }

    public void setPhotos(ArrayList<DoubanMomentPosts.thumbs> photos) {
        this.photos = photos;
    }
